...
- Landing page rebuilt in the app's Dawn palette, modelled on the Red 10 site: hero with a framed bid-composer capture, official App Store badge, rising-bid ladder, mechanics tiles with CSS-drawn dice, an in-person dark band, a swipeable screens rail, a getting-started journey, FAQ, closing CTA.
- New `/how-to-play/` rules page with a worked example round and the optional wild-1s-off, calza and palifico rules.
